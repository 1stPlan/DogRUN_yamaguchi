                            ...
                            <table class="table table-bordered table-striped mt-3" id="user" style="clear: both">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 75%">
                                            <input class="form-control" type="text" name="title"
                                                value="{{ old('title', $event->title) }}" autocomplete="">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input
                                                name="start_datetime" type="datetime" class="form-control date_picker"
                                    ...
                                    <tr>
                                        <th>画像</th>
                                        <td>
                                            <input class="col-sm-10" id="icon2" type="file" class="mt-2"
                                                name="img_url" value="{{ old('img_url', $event->img_url) }}">
                                            <div class="thumbnail">
                                                <img id="icon_img_prv2"
                                                    src="{{ asset('storage/image/event/' . $event->img_url . '.jpg') }}"
                                                    width="100%">
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>ショップイベント</th>
                                        <td>
                                            <label><input type="radio" name="maker" value="1"
                                                    onclick="formSwitch()" checked>なし</label>
                                            <label><input type="radio" name="maker" value="2"
                                                    onclick="formSwitch()">あり</label>
                                        </td>
                                    </tr>
