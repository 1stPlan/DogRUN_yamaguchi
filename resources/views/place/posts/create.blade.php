  ...
  <div class="post_create__inner">
    ...
    <div class="post_create__cont">
      ...
      <form action="{{ route('user.post.store') }}" method="post" enctype="multipart/form-data">
        ...
        <input type="text" class="post_create__form-tit" name="tittle" value="{{old('tittle')}}" placeholder="タイトルを記入">
        ...
        <div class="post_create__form-rating">
          <input class="post_create__form-rating-input" id="star5" name="rating" type="radio" value="5">
          <label class="post_create__form-rating-label" for="star5"><i class="fas fa-star"></i></label>

          <input class="post_create__form-rating-input" id="star4" name="rating" type="radio" value="4">
          <label class="post_create__form-rating-label" for="star4"><i class="fas fa-star"></i></label>

          <input class="post_create__form-rating-input" id="star3" name="rating" type="radio" value="3">
          <label class="post_create__form-rating-label" for="star3"><i class="fas fa-star"></i></label>

          <input class="post_create__form-rating-input" id="star2" name="rating" type="radio" value="2">
          <label class="post_create__form-rating-label" for="star2"><i class="fas fa-star"></i></label>

          <input class="post_create__form-rating-input" id="star1" name="rating" type="radio" value="1">
        ...
        @if($user)
        <input type="text" class="post_create__form-name" name="name" value="{{ $user->name }}" autocomplete="name" placeholder="ニックネームを記入">
        @else
        <input type="text" class="post_create__form-name" name="name" value="{{ old('name') }}" autocomplete="name" placeholder="ニックネームを記入">
        @endif
