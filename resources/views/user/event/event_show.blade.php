...
@section('content')
    ...
    <section class="event_show">
        ...
        <div class="event_show__inner">
            <div class="event_show__cont">
                ...
                <div class="event_show__info">
                    ...
                    <div class="event_show__info-pic">
                        <img class="event_show__info-img"
                            src="{{ $event->img_url ? asset('storage/image/event/' . $event->img_url . '.jpg') : asset('/images/icon.png') }}"
                            alt="" width="100%">
                    </div>
            ...
            <a class="event_show__form-btn" href="{{ route('user.event.post.show', ['event' => $event->id]) }}">掲示板</a>
            <div class="event_show__back-btn">
                <a href="{{ route('user.event') }}">戻る</a>
            </div>
