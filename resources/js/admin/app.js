...
(function(global, factory) {
    ...
    Wrap.prototype = {
        ...
        init: function init(attrs) {
            ...
            // shorthand for DOMReady
                ...
                return this._setup([document]).ready(this.selector); // Array like objects (e.g. NodeList/HTMLCollection)
    ...
    Wrap.extend({
        ...
        siblings: function siblings() {
            ...
            this.each(function(i, item) {
                sibs = sibs.concat(
                    _filter(item.parentNode.children, function(child) {
                        return child !== item;
                    })
                );
            });
                ...
                pie: {
                    ...
                    label: {
                        ...
                        formatter: function formatter(label, series) {
                            return (
                                '<div class="flot-pie-label">' + //label + ' : ' +
...
(function() {
    ...
    function initTranslation() {
        ...
        function applyTranlations() {
            var list = [].slice.call(
                document.querySelectorAll("[data-localize]")
            );
...
(function() {
    ...
    function initExternalEvents() {
        var colorSelectorContainer = document.getElementById(
        ...
        var colorSelectors = [].slice.call(
            colorSelectorContainer.querySelectorAll(".circle")
        );
...
(function() {
    ...
    var Message = function Message(options) {
        ...
        ).data("notifyMessage", this); // status
...
(function() {
    ...
    function initDropzone() {
        ...
        var dropzoneOptions = {
            ...
            maxFiles: 100,
            dictDefaultMessage:
                '<em class="fa fa-upload text-muted"></em><br>Drop files here to upload',
...
(function() {
    ...
    function initCustom() {
        ...
        $(".dropdown_2").on("click", function() {
            ...
            $(this)
                .find(".dropdown_2-menu")
                .slideToggle(300);
        });
        $(".dropdown_2 .dropdown_2-menu li").on("click", function() {
            $(this)
                .parents(".dropdown_2")
                .find("span")
                .text($(this).text());
